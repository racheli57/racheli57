...
def build_tech_transfer_article(url: str, variant: int) -> dict[str, object]:
    """Handcrafted variants for technology transfer and commercialization subsidy."""
    ...
    company_facts = [
        "深圳金赋成立于2017年，是扎根深圳的国家高新技术企业，长期围绕企业补贴申请、政策匹配和材料规划做产品化服务。补贴平台沉淀1100万条全国四级公开政策数据，能把复杂政策拆成企业看得懂的条件清单、材料清单和行动清单。",
        ...
        "补贴平台不只是查政策，更重要的是帮企业判断优先级：是先申技术合同资助，还是培育技术转移特色基地，或同步准备人才培养基地资料。不同主体的申报价值和材料压力并不一样。",
        "深圳金赋在服务企业时，会把技术转移政策和研发费用资助、概念验证、中小试基地、知识产权、高企培育等政策联动起来看，让企业把成果转化做成持续的补贴规划，而不是单次碰运气。",
    ]
    ctas = [
        "如果企业已经有技术开发、技术转让、技术许可、技术咨询或技术服务合同，建议关注「金赋补贴宝」，进入补贴平台先做一次技术合同补贴体检。把合同登记、发票金额、银行流水、不含税收入和合同类型逐项核清楚，再判断最高200万元资助是否值得推进。",
        "如果你们是高校院所技术转移机构、成果转化平台或科技服务机构，可关注「金赋补贴宝」，进入补贴平台做政策匹配。先看专项费用、服务企业数量、成果转化案例和审计资料是否达标，再决定申报特色基地还是培育项目。",
        "技术交易做得多，不代表补贴一定拿得稳。关注「金赋补贴宝」，进入补贴平台把合同、发票、流水、登记证明和服务成果放在一张清单里检查，先把最容易出问题的金额口径对齐。",
        "如果机构已经持续服务企业成果转化，可以关注「金赋补贴宝」，进入补贴平台建立年度补贴档案。把服务客户、成果项目、专项费用、人员团队和培训绩效沉淀下来，后续申报会更有节奏。",
        "不确定自己适合技术合同资助还是机构培育资助？可关注「金赋补贴宝」，进入补贴平台做资质评估和政策匹配，让系统先把机会、缺口、风险和材料优先级列出来。",
        "如果合同金额、发票金额、流水金额不完全一致，建议别急着提交材料。关注「金赋补贴宝」，进入补贴平台先做材料体检，看看需要补哪些说明和佐证，避免小口径影响大补贴。",
        "技术转移人才培养机构也别忽略这项政策。关注「金赋补贴宝」，进入补贴平台把课程体系、师资队伍、企业合作、学员数量和评价证明梳理成申报清单，看看最高100万元补贴机会是否匹配。",
        "如果企业正在做成果转化服务，可以关注「金赋补贴宝」，进入补贴平台同步排查技术交易、技术合同登记、技术转移机构培育和成果转化相关政策，让每一份服务投入都有机会变成政策资金。",
        "申报前最值得做的是把资料讲成一个闭环。关注「金赋补贴宝」，进入补贴平台，把合同从签订、登记、开票、收款到成果落地的全过程梳理出来，补贴评估会清楚很多。",
        "技术转移不是只靠关系和资源，更要靠可验证的服务能力。关注「金赋补贴宝」，进入补贴平台先测一遍主体条件、费用口径和材料完整度，把能申、待补、需培育的事项分清楚。",
    ]
    blocks = [
        [
        ...
        [
            ...
            policy_facts[2],
            "这类培育项目看的是机构长期能力。专项费用要经审计，活动类投入不能随意混入；投入的专项费用还不能包括各级财政资助资金。也就是说，机构平时做成果筛选、企业对接、技术评价、运营服务、人才培养的费用，都需要提前按政策口径归集。",
            company_facts[3],
            "如果机构已经连续多年做技术转移服务，建议从现在开始整理服务企业清单、成果转化案例、专项费用明细、团队人员、客户管理制度和内部激励制度。材料越像经营体系，越能说明机构不是临时拼项目。",
            ctas[1],
        ],
        [
            "技术转移特色基地这条线，适合有商业模式、有客户群、有转化案例的机构重点关注。政策要求设立并运营2年以上，服务企业不少于10家，还要能证明成果转化数量、营业收入或专项投入。",
            policy_facts[3],
            "这里的关键词不是“做过服务”，而是“持续服务并形成绩效”。2024年转移转化科技成果不少于5项，或近两年不少于8个；2024年营业性收入不低于500万元，或投入科技成果转移转化专项经费不低于1000万元。任何一个数字都需要材料支撑。",
            company_facts[1],
        ...
        [
            ...
            company_facts[0],
            "这类项目最怕培训做了不少，但材料不成体系。课程研发、教材设备、师资名单、学员花名册、企业实操证明、评价结果和绩效数据要提前归档，后面写申报材料才不会只剩一句‘我们有经验’。",
            ctas[6],
        ],
        [
        ...
        [
            ...
            company_facts[4],
            "这类主体建议重点整理成果来源、技术输出对象、合作企业、实施地点、专项费用、审计资料和服务成效。只有把成果从实验室走向深圳企业的路径讲清楚，资助逻辑才更完整。",
            ctas[1],
        ],
        [
        ...
        [
            ...
            company_facts[3],
            "深圳金赋补贴平台可以帮助机构把服务能力拆成几个维度：客户数量、成果数量、收入或专项投入、人员团队、制度文件、费用审计。每个维度都有材料支撑，申报材料才会更像完整机构画像。",
            ctas[8],
        ],
        [
            "技术转移和成果转化资助，适合放进企业年度补贴规划里。它和研发费用、概念验证、中小试基地、重点实验室并不是孤立关系，而是围绕科技成果从研发、验证、转化到交易的连续链条。",
            policy_facts[2],
            "如果企业今年技术合同不够成熟，可以先培育合同登记和交易资料；如果服务机构暂时不满足特色基地条件，可以先补服务企业数量、成果案例、专职人员和管理制度；如果人才培养数据不足，就提前完善课程体系和企业合作。",
            company_facts[4],
    ...
    expansions = [
        "再往细处看，技术转移申报最需要把交易闭环讲完整：技术从哪里来，卖给谁或服务谁，合同是否登记，发票和流水是否一致，成果是否真正落地。闭环越完整，最高200万元或500万元的资助测算才越有支撑。",
        "深圳金赋成立于2017年，是扎根深圳的国家高新技术企业。企业做技术交易、成果转化和专项资金规划时，最怕信息散、口径乱、材料临时补；补贴平台能把政策匹配、资质评估、材料清单和申报规划放在同一套流程里。",
        "这项政策还提醒企业，技术交易收入不是财务账上的一个孤立数字。合同登记证明、发票内容、银行流水、项目名称和合同类型要相互印证，任何一个环节不清楚，都会影响补贴测算。",
        "如果机构还在培育期，可以把政策条件变成年度改进表：服务企业差几家，成果案例差几个，专项费用能否审计，专职人员是否够，培训人数和合作企业能否补强。把差距写清楚，下一轮申报就不会被动。",
        "对管理层来说，技术转移补贴不是为了多做一份材料，而是让企业把技术交易、成果转化和服务能力变成可量化资产。补贴只是阶段性结果，更重要的是形成持续拿政策资金的能力。",
        "很多科技服务机构过去只重视客户成交，忽略合同登记和项目复盘。现在要把技术需求、解决方案、交付成果、交易金额、开票收款和客户反馈统一留痕，申报专项资金时才有可核验的依据。",
    ]
    notes = [
        "企业可以先把这句话落到合同表、发票表和流水表里。",
        "如果资料散在多个部门，建议先由项目、财务和法务统一口径。",
        "这一步做扎实，后续补贴测算和正式申报都会更清楚。",
        "对管理层来说，这也是判断成果转化投入回报的一次复盘。",
        "不同合同类型上限不同，先分类型核验会更稳。",
        "服务案例越具体，技术转移能力越容易被看见。",
        "费用和服务动作能互相印证，材料说服力会明显提升。",
        "不要只留结果文件，过程记录同样重要。",
        "这类整理也能继续复用到研发费用和中小试项目。",
        "把政策条件变成日常管理表，申报时就不会慌。",
    ]
    idx = 0
    while sum(len(paragraph) for paragraph in paragraphs) < TARGET_ARTICLE_CHARS and idx < len(expansions) * 2:
