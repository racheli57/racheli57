...
# 默认只输出当前用户本轮提供的政策链接。
POLICY_URLS = ['http://qh.sz.gov.cn/sygnan/xxgk/xxgkml/zcfg/zcjd/content/post_4419152.html',
 ...
 'http://www.szft.gov.cn/gkmlpt/content/8/8012/post_8012169.html',
 'http://www.cjr.org.cn/info/laws/content/post_161536.html',
 'http://www.dpxq.gov.cn/xxgk/xxgk/zcfg/zcjd/content/post_3261995.html',
 'http://www.sz.gov.cn/gkmlpt/content/7/7787/post_7787394.html',
 'http://www.szft.gov.cn/bmxx/qwjj/zwxxgk/zcfg/content/post_4713186.html',
 'http://www.yantian.gov.cn/ytczj/gkmlpt/content/5/5889/post_5889700.html',
 'http://meeb.sz.gov.cn/xxgk/zcfg/zcjd/content/post_2017169.html',
 'http://www.szft.gov.cn/gkmlpt/content/5/5772/post_5772002.html',
 'http://www.dpxq.gov.cn/xxgk/xxgk/zcfg/zcjd/content/post_3262003.html',
 'http://www.szlh.gov.cn/lhqwbgs/gkmlpt/content/7/7650/post_7650181.html',
 'http://www.szft.gov.cn/gkmlpt/content/9/9259/post_9259460.html',
 'http://hsa.sz.gov.cn/zwgk/zcfgjzcjd/zcfg/content/post_8329866.html',
 'http://www.dpxq.gov.cn/gkmlpt/content/5/5644/post_5644254.html',
 'http://www.sz.gov.cn/gkmlpt/content/7/7786/post_7786872.html',
 'http://www.szft.gov.cn/gkmlpt/content/7/7956/post_7956092.html',
 'http://www.szft.gov.cn/bmxx/qfzhggj/zwxxgk/zcfg/content/post_4740800.html',
 'http://www.szft.gov.cn/gkmlpt/content/5/5777/post_5777111.html',
 'http://sf.sz.gov.cn/xxgk/xxgkml/zcfg/content/post_2979532.html',
 'http://www.szlh.gov.cn/lhgyjdbsc/gkmlpt/content/6/6211/post_6211271.html',
 'http://www.szlhq.gov.cn/gkmlpt/content/5/5797/post_5797517.html',
 'http://www.szft.gov.cn/gkmlpt/content/6/6923/post_6923789.html',
 'http://www.szft.gov.cn/gkmlpt/content/5/5793/post_5793225.html',
 'http://www.szns.gov.cn/xxgk/qzfxxgkml/zcwj/qjzcwj/content/post_8642254.html',
 'http://www.szft.gov.cn/ftqkjj/gkmlpt/content/6/6065/post_6065280.html',
 'http://cgj.sz.gov.cn/zwgk/zcjd/content/post_2140200.html',
 'http://tb.sz.gov.cn/zwgk/zcfdjzcjd/tstzqyszzczy/szsrcwcnyzchb/nyzj/content/post_607840.html',
 'http://www.szft.gov.cn/gkmlpt/content/5/5755/post_5755161.html',
 'http://wjw.sz.gov.cn/xxgk/zcjd/content/post_3166134.html',
 'http://www.szlh.gov.cn/lhqwbgs/gkmlpt/content/7/7650/post_7650156.html',
 'http://www.sz.gov.cn/cn/xxgk/zfxxgj/zcjd/content/post_1387397.html',
 'http://www.sz.gov.cn/zfgb/2021/gb1207/content/post_8997155.html',
 'http://www.szft.gov.cn/gkmlpt/content/8/8358/post_8358422.html',
 'http://www.szft.gov.cn/gkmlpt/content/5/5758/post_5758260.html',
 'http://www.szft.gov.cn/gkmlpt/content/5/5793/post_5793135.html',
 'http://cgj.sz.gov.cn/zwgk/zcfg/lylh/content/post_2127426.html',
 'http://www.szft.gov.cn/gkmlpt/content/5/5755/post_5755566.html',
 'http://www.sz.gov.cn/gkmlpt/content/7/7786/post_7786535.html',
 'http://www.szft.gov.cn/bmxx/qmzj/zwxxgk/zcfg/content/post_4378701.html',
 'http://www.sz.gov.cn/cn/xxgk/zfxxgj/zcjd/content/post_7798298.html',
 'http://www.szns.gov.cn/nsxljdb/gkmlpt/content/6/6431/post_6431799.html']
...
PROMOTION_PLANS = [('前海服务业企业别等项目落地后才找补贴', '前海现代服务、跨境服务、金融科技、专业服务和创新平台企业', '区域政策、跨境便利、现代服务业、人才支持、办公空间和产业贡献', '注册证明、租赁合同、服务合同、经营数据、人员材料、纳税证明和项目说明'),
 ('工程管理资料别只归档，也要服务未来政策申报', '施工、设计、监理、造价咨询、检测和工程管理企业', '工程质量、安全管理、资质等级、项目备案、绿色施工和信用评价', '工程合同、施工资料、验收文件、人员证书、费用凭证、信用记录和项目总结'),
 ('福田企业资金项目，别只看通知更要看自身条件', '福田区科技、商贸、专业服务、总部经济和成长型企业', '区级资金支持、产业定位、经营贡献、项目投入、办公空间和人才服务', '营业执照、营收纳税、租赁合同、项目合同、费用票据、人员社保和发展计划'),
 ('大鹏企业做特色产业，生态和合规资料要提前备好', '大鹏新区文旅、海洋、生态农业、民宿、体育和科技服务企业', '生态保护、文旅消费、特色产业、项目投入、品牌推广和经营成效', '项目方案、经营数据、合同票据、宣传资料、安全记录、生态合规和效果报告'),
 ('融资已经发生，企业还要看能否降低资金成本', '科技企业、专精特新企业、拟上市企业和需要融资支持的成长型企业', '贷款贴息、担保补助、上市培育、风险补偿、绿色金融和产业基金', '授信合同、借款合同、利息凭证、担保资料、财务报表、资金用途和项目进展'),
 ('宝安企业做环保和节能，投入凭证要从项目初期留好', '宝安区制造业、园区运营、环保服务、节能改造和绿色供应链企业', '污染治理、节能降碳、环保设施、绿色改造、监测数据和合规管理', '环保批复、设备合同、监测报告、发票付款、运行台账、能耗数据和验收材料'),
 ('福田商贸服务企业，区级政策往往看经营贡献和活动成效', '福田区商贸、专业服务、科技服务、文化消费和楼宇企业', '经营贡献、促消费活动、品牌建设、办公空间、人才服务和产业集聚', '营收纳税、活动方案、合同发票、付款凭证、租赁材料、人员社保和效果报告'),
 ('天气风险管理也有价值，安全台账别等检查才补', '受天气影响较大的建筑、交通、文旅、物流、农业和户外活动企业', '气象安全、防灾减灾、应急预案、风险管理、公共安全和服务保障', '应急预案、培训记录、设施检查、活动方案、安全台账、保险资料和处置记录'),
 ('金融机构和融资平台，合规资料越完整越利于政策衔接', '金融服务机构、类金融企业、融资平台和需要规范融资的企业', '监管要求、合规经营、风险防控、融资服务、信息报送和信用管理', '经营资质、内控制度、合同资料、客户台账、财务报表、风险说明和整改记录'),
 ('物流和出行企业做补贴准备，要从运营台账开始', '物流运输、道路客货运、供应链、港航服务和出行服务企业', '运输资质、车辆设备、安全管理、绿色低碳、服务保障和运营数据', '车辆资料、运营台账、安全记录、设备合同、发票付款、能耗数据和服务评价'),
 ('福田稳增长项目，企业要把贡献和投入讲清楚', '福田区制造业、商贸服务、专业服务、科技创新和总部经济企业', '稳增长、经营贡献、项目投资、产业空间、企业培育和区级配套', '纳税数据、营收报表、投资合同、费用票据、员工社保、项目成果和发展规划'),
 ('适老助残服务，也可能成为企业社会价值项目', '康复服务、辅助器具、适老化改造、养老托育和公益服务企业', '残疾人服务、适老化环境、公益项目、设备投入、服务能力和社会效益', '服务方案、人员资质、设备清单、服务记录、合同票据、场地资料和效果反馈'),
 ('大鹏项目不是越大越好，特色和落地证据更关键', '大鹏新区生态文旅、海洋经济、民宿餐饮、体育活动和科技服务企业', '区域特色产业、生态合规、项目落地、品牌宣传、服务能力和经营成效', '项目计划、营业数据、合同发票、活动照片、宣传资料、安全记录和复盘报告'),
 ('市级政策机会多，企业要先做一轮匹配筛选', '深圳科技、制造、服务业、商贸和成长型企业', '市级扶持方向、企业主体、项目周期、费用范围、资质基础和材料成熟度', '企业画像、财务数据、项目清单、合同票据、知识产权、人员信息和资质证明'),
 ('福田健康服务和商业场景，项目投入要留下证据', '福田区医疗健康、生活服务、商贸消费、社区服务和专业服务企业', '健康服务、经营规范、消费场景、服务质量、人员资质和项目投入', '服务记录、人员证书、场地资料、合同发票、付款凭证、客户反馈和项目说明'),
 ('盐田财政资金机会，企业要算清项目价值和合规边界', '盐田区港口物流、文旅消费、现代服务、科技和绿色发展企业', '财政资金、区域产业、经营贡献、项目投入、合规管理和绩效目标', '财务报表、纳税证明、项目合同、费用票据、绩效数据、信用记录和申报说明'),
 ('环保投入别只当成本，绿色项目也要纳入补贴规划', '制造业、园区运营、环保服务、节能设备和绿色供应链企业', '环境治理、节能减排、污染防治、绿色改造、监测数据和合规证明', '环保批复、检测报告、设备合同、发票付款、运行台账、能耗数据和验收资料'),
 ('福田产业空间和经营数据，可能就是申报加分项', '福田区楼宇企业、专业服务、科技企业、商贸主体和总部经济企业', '产业空间、办公载体、经营贡献、企业培育、项目投资和人才支撑', '租赁合同、场地照片、营收纳税、项目合同、人员社保、资质证书和发展计划'),
 ('大鹏政策机会要结合片区定位，别只看补贴金额', '大鹏新区文旅、海洋、生态农业、体育、民宿和科技服务企业', '片区定位、特色产业、生态保护、项目投入、市场推广和安全管理', '项目方案、经营台账、合同票据、宣传资料、审批材料、安全记录和成效说明'),
 ('罗湖企业服务政策，适合先做一张机会清单', '罗湖区商贸、专业服务、黄金珠宝、跨境服务和成长型企业', '区域产业定位、企业服务、商贸消费、专业服务、人才支持和项目投入', '注册地址、租赁材料、营收纳税、项目合同、费用票据、人员资料和资质证明'),
 ('福田专项资金别临时抱佛脚，材料库要提前建', '福田区科技、金融、商贸、文创和专业服务企业', '专项资金、产业扶持、项目投入、企业贡献、材料审核和绩效管理', '申请表基础信息、财务资料、合同发票、付款凭证、项目成果、信用记录和复盘材料'),
 ('医保和民生服务企业，合规经营也是补贴基础', '医疗机构、医药服务、健康管理、养老护理和民生服务企业', '医保合规、服务质量、费用管理、信息报送、人员资质和民生保障', '机构资质、服务记录、人员证书、费用台账、信息系统记录、合同资料和整改说明'),
 ('大鹏企业项目落地后，还要跟踪政策兑现机会', '大鹏新区旅游、海洋、生态、体育、农业和服务业企业', '项目落地、产业方向、经营成效、合规审批、品牌推广和区域贡献', '项目备案、合同发票、运营数据、现场照片、宣传资料、审批记录和效果报告'),
 ('市级项目资金机会，企业要把投入和成果连起来', '深圳制造业、科技服务、现代服务、商贸消费和创新型企业', '市级资金支持、项目投入、创新成果、产业贡献、审核要求和绩效评价', '项目清单、财务报表、合同票据、付款凭证、知识产权、客户案例和成果证明'),
 ('福田科技和服务业企业，政策匹配要看细分场景', '福田区科技创新、软件信息、专业服务、金融科技和商贸企业', '科技创新、现代服务业、企业培育、项目投入、空间载体和人才支撑', '研发资料、项目合同、费用票据、人员社保、知识产权、租赁资料和经营数据'),
 ('发改类项目别只看宏观，企业要找自己的落点', '福田区战略性新兴产业、服务业、绿色发展和投资项目企业', '产业规划、项目投资、绿色低碳、稳增长、重大项目和资金安排', '立项材料、投资合同、付款凭证、能耗数据、经营报表、项目进展和成效说明'),
 ('福田企业做民生服务，日常台账也能服务补贴判断', '福田区社区服务、养老托育、社会组织、民生服务和专业运营机构', '民生服务、机构规范、项目投入、服务人数、场地条件和社会效益', '机构资质、服务记录、场地合同、人员证书、费用票据、满意度反馈和项目总结'),
 ('法务合规不是成本中心，也能帮企业守住补贴机会', '各类需要规范经营、合同管理、知识产权保护和风险控制的企业', '依法经营、合同合规、信用记录、知识产权、争议处理和申报风险防控', '合同台账、制度文件、信用记录、知识产权资料、整改说明、审批记录和内部流程'),
 ('罗湖街道企业别忽略小而实的区级服务政策', '罗湖区街道辖区商户、专业服务、小微企业、楼宇企业和社区服务机构', '街道服务、商户经营、楼宇资源、就业服务、社区配套和小微培育', '营业执照、租赁合同、经营流水、员工社保、活动记录、费用票据和服务反馈'),
 ('龙华成长型企业，要把区域政策变成年度补贴图', '龙华区制造业、科技企业、商贸服务、数字经济和成长型企业', '企业培育、项目投入、产业空间、科技创新、经营贡献和人才服务', '企业画像、项目台账、财务报表、合同票据、人员社保、资质证书和发展计划'),
 ('福田文化和消费项目，内容热度也要沉淀成证据', '福田区文化消费、商贸活动、文创运营、品牌推广和楼宇服务企业', '文化消费、活动运营、品牌宣传、客流数据、经营贡献和项目成效', '活动方案、宣传资料、客流数据、合同发票、付款凭证、现场照片和复盘报告'),
 ('福田产业用房和经营贡献，要一起看政策机会', '福田区楼宇经济、总部企业、专业服务、科技企业和商贸主体', '办公空间、租金成本、经营贡献、产业集聚、企业培育和人才配套', '租赁合同、场地照片、租金发票、营收纳税、人员社保、项目资料和发展规划'),
 ('南山企业政策机会多，先按行业和项目做分层', '南山区科技、软件信息、智能制造、文化创意和现代服务企业', '区级产业政策、创新项目、企业培育、空间支持、研发投入和经营贡献', '研发资料、项目合同、财务报表、知识产权、人员社保、场地材料和成果证明'),
 ('福田科技项目想拿补贴，研发和成果要能互相证明', '福田区科技型企业、软件信息、硬科技、研发平台和技术服务企业', '研发投入、科技项目、知识产权、成果转化、企业培育和人才团队', '研发立项、费用明细、专利软著、检测报告、技术合同、人员资料和成果说明'),
 ('城市管理和绿色服务企业，也要关注项目型资金机会', '环卫、园林绿化、城市服务、设施运营、绿色低碳和公共服务企业', '城市管理、园林绿化、环境维护、设施更新、服务质量和安全运营', '服务合同、作业记录、设备清单、发票付款、人员培训、现场照片和考核结果'),
 ('新能源车辆和运输企业，运营数据就是政策语言', '新能源运输、物流配送、客货运、车辆运营和供应链服务企业', '新能源车辆、运输资质、运营里程、安全管理、节能降碳和服务保障', '车辆资料、运营台账、充电记录、能耗数据、合同发票、安全记录和服务评价'),
 ('福田经济服务政策，企业要主动把贡献讲出来', '福田区商贸、金融、专业服务、科技服务和总部经济企业', '经济贡献、企业培育、招商引资、项目投入、人才服务和产业生态', '纳税证明、营收数据、投资合同、租赁资料、人员社保、荣誉资质和发展计划'),
 ('卫健服务机构做项目，别忘了把质量和成效留下来', '医疗卫生、健康管理、养老护理、康复服务和生命健康企业', '医疗服务、质量管理、人员资质、项目投入、服务成效和合规记录', '机构资质、人员证书、服务台账、合同票据、质量记录、客户反馈和项目总结'),
 ('罗湖企业服务项目，适合用补贴平台先测一遍', '罗湖区商贸、专业服务、黄金珠宝、跨境电商和小微企业', '企业服务、产业培育、商圈活力、经营贡献、人才支持和项目投入', '营业执照、租赁合同、经营数据、活动资料、费用票据、人员社保和资质证明'),
 ('市级政策口径变化，企业要及时更新申报地图', '深圳各类科技、制造、服务业、商贸和成长型企业', '市级政策调整、资金方向、项目条件、材料口径、产业重点和申报节奏', '企业画像、项目清单、财务数据、合同票据、人员资料、资质证书和政策记录'),
 ('市政府公报里的机会，企业别只当资料存档', '深圳制造业、科技服务、现代服务、商贸文旅和创新型企业', '市级规范文件、产业方向、资金管理、申报条件、企业责任和监督要求', '政策台账、项目资料、财务报表、合同票据、信用记录、成果说明和内部分工'),
 ('福田资金事项更新后，企业要立刻看匹配度', '福田区科技、商贸、金融、专业服务和文化消费企业', '区级资金事项、项目条件、经营贡献、申报窗口、材料成熟度和绩效要求', '申请资料、经营数据、合同发票、付款凭证、租赁材料、人员社保和成果报告'),
 ('福田民生和社区服务项目，也需要经营化管理', '福田区民生服务、社区运营、社会组织、养老托育和专业服务机构', '民生服务、社区项目、机构规范、服务人数、项目投入和社会效益', '机构资质、服务记录、场地合同、人员证书、费用票据、满意度反馈和项目总结'),
 ('福田产业政策别孤立看，要和全年项目排期联动', '福田区科技、金融、商贸、专业服务、文化创意和总部经济企业', '产业扶持、企业培育、空间支持、人才服务、经营贡献和项目投入', '年度项目表、财务数据、合同票据、租赁资料、人员社保、资质荣誉和成果证明'),
 ('园林绿化企业做项目，现场和养护资料也有价值', '园林绿化、城市管养、生态修复、物业服务和公共空间运营企业', '园林绿化、养护服务、工程质量、设施管理、安全生产和绿色生态', '养护记录、工程合同、现场照片、人员培训、设备清单、发票付款和验收资料'),
 ('福田企业做经营复盘，顺手把补贴机会也筛出来', '福田区中小企业、商贸服务、科技创新、专业服务和楼宇企业', '经营贡献、项目投入、企业培育、行业资质、空间载体和政策配套', '营收纳税、项目合同、费用票据、人员社保、租赁资料、资质证书和发展计划'),
 ('市级资金规则一变化，企业材料口径也要跟着调', '深圳各类拟申报专项资金的科技、制造、服务和商贸企业', '资金管理、预算绩效、申报审核、重复申报限制、信用管理和项目监督', '项目台账、财务报表、合同票据、付款凭证、信用记录、绩效说明和内部制度'),
 ('福田社会服务机构，项目成效越清楚越容易匹配政策', '福田区社会组织、社区服务、养老托育、公益服务和专业运营机构', '社会服务、机构规范、项目投入、服务覆盖、公益成效和运营能力', '机构资质、服务台账、人员证书、场地资料、费用凭证、满意度反馈和总结报告'),
 ('市级政策观察：企业要把零散机会变成长期补贴库', '深圳科技、制造、商贸、文旅、金融和专业服务企业', '政策趋势、产业重点、资金方向、企业培育、项目储备和材料规范', '企业画像、项目储备、费用台账、资质证书、合同票据、成果案例和政策日历'),
 ('南山街道企业也能做政策匹配，小项目别被忽略', '南山区街道辖区科技服务、商贸小微、专业服务、社区配套和创新创业企业', '街道服务、企业培育、创新创业、经营贡献、空间资源和社区配套', '营业执照、租赁合同、经营流水、员工社保、项目资料、费用票据和服务记录')]
