...
PLAN_BY_POST_ID.update({
    ...
    "12817823": (
        "概念验证中心最高500万",
        "计划建设概念验证中心的高等院校、科研机构、医疗卫生机构、科技企业、社会组织，以及正在做科技成果转化服务、创业孵化、产业链协同和早期项目筛选的新型载体",
        "概念验证服务费用、上两个年度实际投入、扣除各级财政资助资金、第三方审计、单个项目最高500万元、事后补助、项目库不少于5个、对外提供概念验证服务、专门用房不少于200平方米、主任条件、技术经纪经理人不少于2名、服务团队不少于10人、专职服务人员不少于5人、80%人员学历或职称要求、专家团队不少于5人、不得委托中介机构申报、同一单位不超过2个项目",
        "概念验证中心建设方案、运行管理制度、服务制度、概念验证项目库、入库项目资料、对外服务合同、服务费用明细、第三方审计报告、场地证明、200平方米以上专门用房资料、中心主任简历和学历职称、技术经纪经理人证书、服务团队花名册、社保或劳动关系资料、专家团队名单、产学研投合作证明、科技计划项目和验收材料、科技伦理和科技安全合规资料",
    ),
    "12809327": (
        "重点实验室组建资助来了",
...
FALLBACK_POLICY_BY_POST_ID.update({
    ...
    "12817823": (
        ...
        "2026年度深圳市概念验证中心认定资助项目鼓励高等院校、科研机构、医疗卫生机构、企业和社会组织聚集成果、人才、资本和市场等转化要素，营造概念验证生态系统，对具备良好概念验证、创业孵化等条件的新型载体予以支持，重点支持深圳市战略性新兴产业集群和未来产业领域。资助资金按照不超过申请单位经第三方审计机构出具的上两个年度扣除各级财政资助资金后实际投入的概念验证服务费用予以支持，单个项目最高不超过500万元，支持方式为事后补助。申请单位应在深圳市含深汕特别合作区依法实际从事经营活动，具备法人资格，可为高等院校、科研机构、医疗卫生机构、企业和社会组织。申请单位应制定完善的概念验证中心建设方案，具有明确目标、完整服务和运行管理制度。高校、科研机构和医疗卫生机构应曾承担市级及以上科技计划项目，具备技术储备、技术扩散能力和概念验证服务成功经验；企业和社会组织应与产业链上下游企业等建立长期稳定委托合作关系，具备概念验证商业委托开发能力。申请单位应建立概念验证项目库，入库项目不少于5个，并对外提供概念验证服务；应具备相对固定的概念验证专门用房，用房面积不少于200平方米。概念验证中心主任需熟悉基础研究、概念验证、创业孵化、投融资等全链条科技成果转化流程，具有本科含以上学历或中级含以上职称。服务人才团队需聘任具有职业技术经纪经理人职称证书或相关培训结业证书的专职职业技术经纪经理人不少于2名；项目服务人才团队总人数不少于10人，其中专职服务人员不少于5人，具有本科含以上学历或中级含以上职称的人员不低于总人数的80%。项目遴选顾问专家团队总人数不少于5人，并由学术界、产业界和投资界专家组成，负责项目库入库项目遴选和评价。申请单位、中心主任及服务人才团队成员不得存在财政性资金项目惩戒情形，不得委托中介机构申报，同一项目不得多头和重复申报，概念验证中心专职人员和研发场地不得与市级及以上创新载体重复；涉及科技伦理和科技安全的，应符合国家有关法律法规和伦理准则。同一申请单位申请项目不超过2个。",
    ),
    "12809327": (
...
def build_article_from_url(url: str, index: int) -> dict[str, object]:
    ...
    if post_id == "12817823":
        return build_concept_verification_article(url, index)
