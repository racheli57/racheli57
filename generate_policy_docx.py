...
PLAN_BY_POST_ID = {
    "12821085": (
        "鸿蒙应用最高200万，企业先测匹配",
        "南山区规上互联网企业、软件信息服务业企业、鸿蒙原生应用开发团队和数字经济企业",
        "南山区实际经营、规上64或65行业代码、鸿蒙原生应用认证、HarmonyOS 5.0及以上应用市场上架、累计下载量超过1万、近三个月平均月活量和单企最多4款应用",
        "营业执照、南山区经营证明、数据申报证明、鸿蒙原生应用认证、应用市场上架截图、下载量证明、近三个月月活数据、财务制度和信用记录",
    ),
}
...
FALLBACK_POLICY_BY_POST_ID = {
    "12821085": (
        "南山区促进产业高质量发展专项资金——区工业和信息化局分项资金-鸿蒙原生应用开发扶持项目操作规程（2026年度）",
        "最高不超过200万元奖励，单个应用按近三个月平均月活分档：5千给10万元、5万给30万元、50万给50万元，每家企业最多申报4款应用。政策鼓励企业开发鸿蒙原生应用。对符合条件的互联网或软件企业开发的鸿蒙原生应用，通过鸿蒙原生应用认证，并在HarmonyOS 5.0及以上版本应用市场上架后累计下载量超过1万的，根据近三个月平均月活量分档给予奖励。本项目面向在南山区实际开展经营活动、具有独立承担民事责任能力、数据申报地在南山区的规上互联网和软件信息服务业企业，国民经济行业分类代码前两位为64或65。企业需履行数据申报义务、守法经营、诚实守信，有规范财务制度，并积极配合区委区政府相关工作。资金采取无偿资助和事后补贴制，属于核准类项目，受年度资金预算控制。"
    ),
}
