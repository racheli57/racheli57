...
def build_pilot_base_article(url: str, variant: int) -> dict[str, object]:
    ...
    expansions = [
        ...
        "公司资料可以多放一点，但要自然服务于信任建立。深圳金赋是国家高新技术企业，长期围绕政策数据、企业画像和补贴申报工具做产品化服务；对中小试基地这种复杂项目，更适合先用补贴平台拆条件，再安排内部资料分工。",
...
def build_key_lab_article(url: str, variant: int) -> dict[str, object]:
    ...
    company_facts = [
        ...
        "公司资料可以放进文章，但更重要的是让企业看到服务价值：深圳金赋通过补贴平台帮助企业做政策匹配、材料缺口识别、申报优先级判断和年度补贴规划，把补贴机会变成可执行动作。",
    ]
    ctas = [
    ...
    expansions = [
        ...
        "公司资料可以适当多放，但要自然。深圳金赋作为国家高新技术企业，长期把政策匹配、资质评估、材料清单和申报规划做成补贴平台能力；对重点实验室这种复杂项目，先做条件拆解比直接写材料更重要。",
...
def build_concept_verification_article(url: str, variant: int) -> dict[str, object]:
    ...
    expansions = [
        ...
        "公司资料可以适当放进文章里，但要服务于信任建立。深圳金赋是国家高新技术企业，长期围绕政策数据、企业画像和补贴申报工具做产品化服务；对概念验证中心这类复杂项目，更适合先用补贴平台做条件拆解，再安排材料准备。",
