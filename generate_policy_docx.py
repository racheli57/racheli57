...
PLAN_BY_POST_ID = {
    "12821085": (
        "南山软件租金补贴最高500万，企业先测匹配",
        "南山区规上互联网企业、软件信息服务业企业、数字经济企业和正在租赁自用办公用房的成长型软件企业",
        "南山区实际经营、规上64或65行业代码、数据申报地在南山区、租赁自用办公用房、合同期1年及以上、营收5亿/10亿/20亿门槛、5000平米/8000平米/10000平米面积上限、20%/30%/40%补贴比例和不含税租金口径",
        "营业执照、南山区经营证明、数据申报证明、租赁合同、房租发票、付款凭证、不含税租金明细、营收数据、财务制度和信用记录",
    ),
}
...
FALLBACK_POLICY_BY_POST_ID = {
    "12821085": (
        "南山区促进产业高质量发展专项资金——区工业和信息化局分项资金软件产业空间扶持项目操作规程（2026年）",
        "对符合条件的互联网或软件企业在南山区内租赁自用办公用房（不含南山区政策性产业用房）的，按实际支付租金的一定比例给予租金补贴，每年最高500万元。合同期在1年及以上的，按实际支付租金核算。上年度1-11月营收5亿元含以上10亿元以下的企业，申请租金补贴面积最高不超过5000平米；营收10亿元含以上20亿元以下，最高不超过8000平米；营收20亿元含以上，最高不超过10000平米。上年度1-11月营收同比增长0%含以上10%以下，按实际支付金额的20%给予补贴；增长10%含以上20%以下，按30%给予补贴；增长20%含以上，按40%给予补贴。如当年1-12月营收低于1-11月营收，则按1-12月营收计算。无同期营收数据导致无法计算增速的企业，视为符合最高档增速。本项目面向在南山区实际开展经营活动、数据申报地在南山区的规上互联网和软件信息服务业企业，国民经济行业分类代码前两位为64或65。租金按不含税金额核算，需核减增值税专用发票、增值税普通发票税额。资金采取无偿资助和事后补贴制，属于核准类项目，受年度资金预算控制。"
    ),
}
